        ...
        <div class="container">
            <div class="row contact_row" style="margin-top: -7%;">
                ...
                <div class="col-sm-6 contact_info send_message">
                    ...
                    <form class="form-inline contact_box" id="loginFormId" action="ForgotPassword.action" method="post">
                        ...
                        <br><input type="button" onclick="checkValidation();" value="Get Password" class="btn btn-default" style="width: 35%;"/>
                    </form>
                </div>
                <div class="col-sm-3 contact_info send_message">
            	</div>
