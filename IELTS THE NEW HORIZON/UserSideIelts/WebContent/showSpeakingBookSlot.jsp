...
<div class="static-table-area"style="margin-top:50px;">
						...
						<div class="sparkline8-graph">
							<div class="static-table-list">
								<div class="form-group" style="padding-left: 170px;;margin-top: 2%;">
									<label style="margin-left:10px;">Select Speaking Topic Name</label> <select
										name="speaking_test_id" class="form-control" id="speaking_test_id"
										style="width: 50%; margin-bottom: 5%;">
										<option style="z-index:-1;">--Select--</option>
								...
								<div class="form-group-inner" style="z-index:-5;margin-top:60px;">
										<label for="dtp_input2" class="col col-md-1 control-label"
											style="margin-left: 160px; width: 20%; vertical-align: text-top;">
								...
								<div class="form-group" style="padding-left: 40%; margin-bottom: 1%; margin-top: 1%;padding-bottom:10%;margin-top:60px;">
